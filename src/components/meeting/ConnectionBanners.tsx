...
export function ConnectionBanners({ onActivateFreeTrial }: ConnectionBannersProps) {
  return (
    <div className="mb-8">
      ...
      <div className="bg-blue-50 rounded-lg p-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm">
            ...
            <button className="text-blue-600 underline" onClick={onActivateFreeTrial}>Try Now</button>
          </span>
        </div>
      </div>
    </div>
